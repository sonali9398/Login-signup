...
const Template = ({title, desc1, desc2, image, formtype, setIsLoggedIn}) => {
  return (
    <div className='flex w-11/12 mx-w-[1160] py-12 mx-auto gap-x-12 gap-y-0 justify-between'>
        <div>
            <h1 className='text-richblack-5 font-semibold text-{1.875] leading-[2.375rem]' >
                {title}
            </h1>
        ...
        <div className='relative w-11/12 max-w-[450px]'>
            ...
            <img src={frameImage} alt="Students" width={558} height={504} loading="lazy" 
